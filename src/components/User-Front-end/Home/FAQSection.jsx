  ...
  const faqData = [
    {
      ...
      answer:
        'Our platform uses cutting-edge AI face recognition technology to detect and match faces in photos with remarkable accuracy. By mapping unique facial features and comparing them to a database, the system identifies and organizes your photos quickly and securely. Privacy is a priority, ensuring all data is encrypted and handled safely, giving you full control over how your images are used.',
    },
    {
      id: 'panel2',
    ...
    },
    {
      ...
      answer:
        'Once you find your photos, you can download them directly to your device. Premium users get unlimited downloads, while free users can download up to 5 photos per month.',
    },
    {
      id: 'panel5',
      question: 'What file formats are supported?',
      answer:
        'We support all major image formats including JPEG, PNG, HEIC, and RAW files. Photos are typically delivered in high-resolution JPEG format for optimal quality and compatibility.',
    },
  ];
    ...
    >
      <Container maxWidth="md">
        <Box sx={{ mb: 4 }}>
          ...
          >
            Here are some common questions to help you understand <br /> our
            platform better.
          </Typography>
        </Box>
