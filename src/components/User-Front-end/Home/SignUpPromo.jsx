...
const SignUpPromo = () => {
  ...
  return (
    <Box sx={{ backgroundColor: '#FAE6D7', py: { xs: 6, md: 10 } }}>
      <Container maxWidth="lg">
        ...
        >
          ...
          <Grid item xs={12} md={7}>
            ...
            >
              Join now & unlock 100 <br /> photo credits{' '}
            ...
            >
              Create your account now and instantly receive 100 <br />
              Photo Credits to explore.
            </Typography>
            ...
            >
              Use them to access all our premium features and start <br />
              finding your event photos with ease—completely free!
            </Typography>
