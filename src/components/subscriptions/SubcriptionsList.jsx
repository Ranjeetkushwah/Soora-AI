...
//   const [currentPage, setCurrentPage] = useState(1);
  ...
  const handleCheckboxChange = (id) => {
    const updated = subscriptions.map(subscription =>
      subscription.id === id ? { ...subscription, isSelected: !subscription.isSelected } : subscription
    );
  ...
  return (
    ...
    <Container>
      <Paper elevation={1} sx={{ borderRadius: 2, overflow: 'hidden' }}>
        ...
        <TableContainer>
          <Table>
            <TableHead sx={{ backgroundColor: '#1F3A63',borderRadius:"8px" }}>
              <TableRow>
                <TableCell padding="checkbox" sx={{ color: 'white', fontWeight: 600, fontSize: '0.75rem' }}>
              <Checkbox sx={{ color: 'white' }} />
                </TableCell>
                <TableCell sx={{ color: 'white', fontWeight: 600, fontSize: '0.75rem' }}>
            ...
            <TableBody>
              {filteredSubscriptions.map((subscription) => (
                ...
                >
                  ...
                  <TableCell>
                    <Typography variant="body2">
                      {subscription.photos === 0 ? '-' : subscription.photos.toLocaleString()}
                    </Typography>
                  </TableCell>
                  <TableCell>
                    <Typography variant="body2" fontWeight={500}>
        ...
        {/* Footer */}
        <Box sx={{ p: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#fafafa' }}>
